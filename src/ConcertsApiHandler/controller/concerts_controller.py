...
class ConcertsController:
    ...
    def get_concerts_action(self, parameters: dict, body: dict) -> func.HttpResponse:
        """
        Example:
        ...
        :raises BadRequestError: For validation errors. Example:
            "Parameter invalid! artist must have minimal 2 characters"
        """
        try:
        ...
        return func.HttpResponse(
            json.dumps(
                self.repository.find_concerts_by_artist(parameters.get('artist'))
            ),
            mimetype="application/json",
        )
        
        
    def put_concert_action(self, parameters: dict, body: dict) -> func.HttpResponse:
        """
        Example:
        ...
        return func.HttpResponse(
            json.dumps(self.repository.create_concert(body)),
            mimetype="application/json",
        )
